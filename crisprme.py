...
def complete_search():
    ...
    if "--genome" not in input_args:
        ...
        try:
            genomedir = input_args[input_args.index("--genome")+1]
        except IndexError:
    ...
    if "--vcf" not in input_args:
        ...
        try:
            vcfdir = input_args[input_args.index("--vcf")+1]
        except IndexError:
    ...
    if "--guide" not in input_args:
        ...
        try:
            guidefile = input_args[input_args.index("--guide")+1]
        except IndexError:
    ...
    if "--pam" not in input_args:
        ...
        try:
            pamfile = input_args[input_args.index("--pam")+1]
        except IndexError:
    ...
    if "--annotation" not in input_args:
        ...
        try:
            annotationfile = input_args[input_args.index("--annotation")+1]
        except IndexError:
    ...
    if variant and "--samplesID" not in input_args:
        ...
        try:
            samplefile = input_args[input_args.index("--samplesID")+1]
        except IndexError:
    ...
    if "--output" not in input_args:
        ...
        try:
            outputfolder = input_args[input_args.index("--output")+1]
        except IndexError:
    ...
    if variant:
        os.system(corrected_origin_path+"./automated_search.sh "+genomedir+" "+vcfdir+" "+guidefile+" "+pamfile+" " +
                  annotationfile+" "+samplefile+" "+str(bMax)+" "+str(mm)+" "+str(bDNA)+" "+str(bRNA)+" "+outputfolder)
    else:
        os.system(corrected_origin_path+"./automated_search.sh "+genomedir+" _ "+guidefile+" "+pamfile+" " +
                  annotationfile+" _ "+str(bMax)+" "+str(mm)+" "+str(bDNA)+" "+str(bRNA)+" "+outputfolder)
